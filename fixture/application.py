...
class Application:
    ...
    def open_groups_page_after_creation(self):
        wd = self.wd
    ...
    def create_group(self, group):
        ...
        self.open_groups_page_after_creation()

    def open_contacts_page(self):
        wd = self.wd
        wd.find_element_by_link_text("home").click()

    def open_contacts_page_after_creation(self):
        wd = self.wd
    ...
    def create_contact(self, contact):
        ...
        wd.find_element_by_name("phone2").send_keys(contact.home_phone_secondary)
        ...
        self.open_contacts_page_after_creation()
