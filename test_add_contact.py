...
class test_add_contact(unittest.TestCase):
    ...
    def create_contact(self, driver):
        ...
        driver.find_element_by_xpath("//select[@name='bday']/option[@value='23']").click()
        driver.find_element_by_name("bmonth").click()
        driver.find_element_by_xpath("//select[@name='bmonth']/option[@value='April']").click()
        driver.find_element_by_name("byear").click()
        driver.find_element_by_name("byear").clear()
        driver.find_element_by_name("byear").send_keys("2002")
        driver.find_element_by_name("aday").click()
        driver.find_element_by_xpath("//select[@name='aday']/option[@value='23']").click()
        driver.find_element_by_name("amonth").click()
        driver.find_element_by_xpath("//select[@name='amonth']/option[@value='April']").click()
